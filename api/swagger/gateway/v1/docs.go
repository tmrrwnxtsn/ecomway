            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.payoutResendCodeRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Успешный ответ",
                        "schema": {
                            "$ref": "#/definitions/v1.payoutResendCodeResponse"
                        }
                    },
                    "default": {
                        "description": "Ответ с ошибкой",
    ...
    "definitions": {
        ...
        "v1.paymentCreateRequest": {
            ...
            "properties": {
                ...
                "return_urls": {
                    "description": "Объект, содержащий ссылки для возврата клиента для каждого из возможных результатов проведения платежа",
                    "allOf": [
                        {
        ...
        "v1.paymentReturnURLs": {
            ...
            "properties": {
                "common": {
                    "description": "URL для возврата клиента, используемый когда результат платежа неизвестен или по умолчанию",
                    "type": "string",
                    "example": "https://example.com"
                },
                "fail": {
                    "description": "URL для возврата клиента, используемый при неуспешном осуществлении платежа",
                    "type": "string",
                    "example": "https://example.com/failed"
                },
                "success": {
                    "description": "URL для возврата клиента, используемый при успешном осуществлении платежа",
                    "type": "string",
        ...
        "v1.payoutConfirmRequest": {
            ...
            "properties": {
                "confirmation_code": {
                    "description": "Код подтверждения вывода средств",
                    "type": "string",
                    "example": "123456"
                },
                "lang_code": {
        ...
        "v1.toolListResponse": {
            ...
            "properties": {
                ...
                "tools": {
                    "description": "Массив сохраненных платежных средств клиента",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1.tool"
                    }
