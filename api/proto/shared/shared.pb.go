...
var file_api_proto_shared_shared_proto_rawDesc = []byte{
	...
	0x07, 0x0a, 0x05, 0x5f, 0x66, 0x61, 0x69, 0x6c, 0x22, 0xc0, 0x02, 0x0a, 0x04, 0x54, 0x6f, 0x6f,
	...
	0x61, 0x79, 0x65, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x66, 0x61, 0x6b, 0x65, 0x18, 0x07, 0x20, 0x01,
	...
	0x12, 0x0a, 0x0a, 0x06, 0x57, 0x41, 0x4c, 0x4c, 0x45, 0x54, 0x10, 0x01, 0x42, 0x30, 0x5a, 0x2e,
	...
	0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x62, 0x06,
...
var file_api_proto_shared_shared_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_api_proto_shared_shared_proto_goTypes = []interface{}{
	...
	(*Limits)(nil),               // 4: shared.Limits
	(*Commission)(nil),           // 5: shared.Commission
	(*Method)(nil),               // 6: shared.Method
	(*Error)(nil),                // 7: shared.Error
	(*ReturnURLs)(nil),           // 8: shared.ReturnURLs
	(*Tool)(nil),                 // 9: shared.Tool
	nil,                          // 10: shared.Commission.MessageEntry
	nil,                          // 11: shared.Method.DisplayedNameEntry
	nil,                          // 12: shared.Method.LimitsEntry
	(*structpb.Struct)(nil),      // 13: google.protobuf.Struct
}
var file_api_proto_shared_shared_proto_depIdxs = []int32{
	2,  // 0: shared.Commission.type:type_name -> shared.CommissionType
	10, // 1: shared.Commission.message:type_name -> shared.Commission.MessageEntry
	11, // 2: shared.Method.displayed_name:type_name -> shared.Method.DisplayedNameEntry
	12, // 3: shared.Method.limits:type_name -> shared.Method.LimitsEntry
	5,  // 4: shared.Method.commission:type_name -> shared.Commission
	3,  // 5: shared.Tool.type:type_name -> shared.ToolType
	13, // 6: shared.Tool.details:type_name -> google.protobuf.Struct
	4,  // 7: shared.Method.LimitsEntry.value:type_name -> shared.Limits
